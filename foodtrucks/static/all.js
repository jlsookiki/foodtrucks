...
(function(root, factory) {
  ...
  GoogleMaps.Location = Backbone.Model.extend({
    constructor: function() {
      _.bindAll(this, 'select', 'deselect', 'toggleSelect', 'getLatLng', 'getLatlng', 'toggleMarker');
    ...
    toggleSelect: function() {
      ...
      //console.log('toggling ' + this.owner);

    },
    toggleMarker: function(){
        this.markerView.gOverlay.setVisible(!this.markerView.gOverlay.visible);
    },
